...
public record BingoConfig(int timeLimit, boolean hasOverworld, boolean hasNether, boolean hasEnd, boolean hardMode, Identifier starterDimension, WaitingLobbyConfig playerConfig) {
